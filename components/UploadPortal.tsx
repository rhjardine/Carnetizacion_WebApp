                ...
                <div className="flex gap-2">
                    <div className="relative flex-1">
                        ...
                        <input 
                            ...
                            className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-brand-blue/20 outline-none transition-all ${
                    ...
                    <button
                        ...
                        className={`px-4 rounded-xl font-medium transition-all flex items-center justify-center gap-2 min-w-[140px] ${
                            validationStatus === 'valid'
                        ...
                        >
                            <div className="bg-green-50 border border-green-100 rounded-lg p-3 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-green-900">Pedro Alejandro Castillo</p>
                                    <p className="text-xs text-green-700">Analista de Sistemas • Activo</p>
                                </div>
                            </div>
                        </motion.div>
                    )}
                        ...
                        <div className="space-y-2">
                             {steps.map((step, idx) => (
                                 <div key={idx} className="flex items-center text-xs">
                                     <div className={`w-4 h-4 rounded-full flex items-center justify-center mr-2 border ${
